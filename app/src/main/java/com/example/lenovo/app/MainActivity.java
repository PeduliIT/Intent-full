    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(Main3Activity.EXTRA_NAME, "Basyith");
                moveWithDataIntent.putExtra(Main3Activity.EXTRA_AGE, 23);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Abdul Basyith");
                mPerson.setAge(23);
                mPerson.setEmail("academy@PeduliIT.com");
                mPerson.setCity("Jombang");
